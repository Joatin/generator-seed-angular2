...
module.exports = function (AngularGenerator) {
   ...
   */
  AngularGenerator.prototype.checkPaths = function checkPaths() {
   ...
   */
  AngularGenerator.prototype.storePaths = function storePaths() {
   ...
   */
  AngularGenerator.prototype.computePaths = function computePaths() {
    this.computedPaths = {
